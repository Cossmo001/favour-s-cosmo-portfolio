...
import { CheckCircle2, Award, Rocket, Code2, Globe, Cpu } from "lucide-react";

const services = [
  {
    title: "Mobile App Development",
    desc: "Crafting high-performance, cross-platform mobile applications using React Native and Flutter, focused on exceptional user experience.",
    icon: <Globe className="w-6 h-6 text-primary" />,
  },
  {
    title: "Web Architecture",
    desc: "Designing and building scalable, secure web architectures that power modern digital experiences for businesses of all sizes.",
    icon: <Code2 className="w-6 h-6 text-primary" />,
  },
  {
    title: "Digital Strategy",
    desc: "Strategic technical consulting to help brands navigate the digital landscape and achieve sustainable growth.",
    icon: <Rocket className="w-6 h-6 text-primary" />,
  },
  {
    title: "Technical Leadership",
    desc: "Leading engineering teams and defining technical visions as a CTO to deliver complex digital products.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              As the CTO of Cosmo Intents Lab, I bridge the gap between complex technical architecture and ethereal digital brand experiences.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-32">
            <div className="space-y-8 animate-fade-in-up-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                With over 3 years of experience in the tech industry, I have dedicated my career to building software that doesn't just work, but thrives. My journey started with a passion for mobile development, which quickly evolved into a comprehensive understanding of digital strategy and technical leadership.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                At Cosmo Intents Lab, I lead a team of talented individuals to deliver branding and technological solutions that help businesses stand out in a crowded digital world. I believe in a minimalist approach to design and a maximalist approach to performance.
              </p>
